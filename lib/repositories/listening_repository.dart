...
class ListeningRepository {
  ...
  ListeningExercise? byId(String id) => _exercises.firstWhere(
    ...
    orElse: () => const ListeningExercise(
      ...
      audioUrl: 'asset:sweet-music.mp3',
      durationMs: 10000,
      ...
      ListeningExercise(
        ...
        questions: const [
          ...
          ListeningQuestion(
            ...
            options: [
              ListeningQuestionOption(id: 'a', text: 'Water'),
              ListeningQuestionOption(id: 'b', text: 'Juice'),
              ListeningQuestionOption(id: 'c', text: 'Milk'),
              ListeningQuestionOption(id: 'd', text: 'Soda'),
            ],
            correctOptionId: 'a',
            startMs: 0,
            endMs: 4000,
      ...
      ListeningExercise(
        ...
        questions: const [
          ...
          ListeningQuestion(
            id: 'b_story_q2',
            type: ListeningQuestionType.multipleChoice,
            prompt: 'What does Maya listen to at home?',
            options: [
              ListeningQuestionOption(id: 'a', text: 'A short English story'),
              ListeningQuestionOption(id: 'b', text: 'Music'),
              ListeningQuestionOption(id: 'c', text: 'News'),
      ...
      ListeningExercise(
        ...
        questions: const [
          ...
          ListeningQuestion(
            ...
            options: [
              ListeningQuestionOption(id: 'a', text: 'Brighton'),
              ListeningQuestionOption(id: 'b', text: 'London'),
              ListeningQuestionOption(id: 'c', text: 'Manchester'),
              ListeningQuestionOption(id: 'd', text: 'Liverpool'),
            ],
            correctOptionId: 'a',
            startMs: 0,
            endMs: 4000,
      ...
      ListeningExercise(
        ...
        questions: const [
          ...
          ListeningQuestion(
            id: 'i_markets_q2',
            type: ListeningQuestionType.multipleChoice,
            prompt: 'What does the market teach at the same time?',
            options: [
              ListeningQuestionOption(id: 'a', text: 'Language and culture'),
              ListeningQuestionOption(id: 'b', text: 'Math and science'),
              ListeningQuestionOption(id: 'c', text: 'History and geography'),
              ListeningQuestionOption(id: 'd', text: 'Art and music'),
            ],
            correctOptionId: 'a',
            startMs: 4000,
            endMs: 9000,
      ...
      ListeningExercise(
        ...
        questions: const [
          ...
          ListeningQuestion(
            id: 'i_rest_q2',
            type: ListeningQuestionType.multipleChoice,
            prompt: 'What does rest let the brain do?',
            options: [
              ListeningQuestionOption(id: 'a', text: 'Repair and organize'),
              ListeningQuestionOption(id: 'b', text: 'Stop working'),
              ListeningQuestionOption(id: 'c', text: 'Create stress'),
              ListeningQuestionOption(id: 'd', text: 'Forget everything'),
            ],
            correctOptionId: 'a',
            startMs: 0,
            endMs: 6000,
      ...
      ListeningExercise(
        ...
        questions: const [
          ListeningQuestion(
            id: 'a_energy_q1',
            type: ListeningQuestionType.multipleChoice,
            prompt: 'What does the layer profile energy use in?',
            options: [
              ListeningQuestionOption(id: 'a', text: 'Machine learning inference runtimes'),
              ListeningQuestionOption(id: 'b', text: 'Video games'),
              ListeningQuestionOption(id: 'c', text: 'Web browsers'),
              ListeningQuestionOption(id: 'd', text: 'Music players'),
            ],
            correctOptionId: 'a',
            startMs: 0,
            endMs: 7000,
      ...
      ListeningExercise(
        ...
        questions: const [
          ...
          ListeningQuestion(
            id: 'a_photo_q2',
            type: ListeningQuestionType.multipleChoice,
            prompt: 'What do proton gradients drive?',
            options: [
              ListeningQuestionOption(id: 'a', text: 'ATP synthase'),
              ListeningQuestionOption(id: 'b', text: 'Water pumps'),
              ListeningQuestionOption(id: 'c', text: 'Cell walls'),
              ListeningQuestionOption(id: 'd', text: 'DNA replication'),
            ],
            correctOptionId: 'a',
            startMs: 4000,
            endMs: 9000,
      ...
      ListeningExercise(
        ...
        questions: const [
          ListeningQuestion(
            id: 'a_rest_q1',
            type: ListeningQuestionType.multipleChoice,
            prompt: 'What does deliberate rest allow?',
            options: [
              ListeningQuestionOption(id: 'a', text: 'Pruning of fragile associations'),
              ListeningQuestionOption(id: 'b', text: 'Instant memory loss'),
              ListeningQuestionOption(id: 'c', text: 'Continuous work'),
              ListeningQuestionOption(id: 'd', text: 'Permanent fatigue'),
            ],
            correctOptionId: 'a',
            startMs: 0,
            endMs: 7000,
