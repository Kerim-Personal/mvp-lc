// lib/lessons/grammar/b1/future_in_past_lesson.dart
              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      ...
                      Example(
                          ...
                          category: '**Predictions (from past):**',
                          sentence: '*She said it **would rain** tomorrow.*'),
                      Example(
                          icon: Icons.repeat,
                          category: '**Repeated Past Actions:**',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      [
                        '**Would** + verb',
                        'Future from past view (Reported)',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      ['*"We **are going to** visit."*', '*They said they **were going to** visit.*'],
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**"Going To" vs "Would":** Use **"was/were going to"** for plans made in the past. Use **"would"** for predictions made in the past or reported speech.',
                      '**Reported Speech:** This is the most common use of "future in the past".',
                      '**Time Expressions:** Time expressions often shift (e.g., "tomorrow" becomes "the next day").',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
