// lib/lessons/grammar/c1/future_in_past_lesson.dart
...
class FutureInPastLessonScreen extends StatefulWidget {
  const FutureInPastLessonScreen({super.key});

  @override
  State<FutureInPastLessonScreen> createState() =>
      _FutureInPastLessonScreenState();
}

class _FutureInPastLessonScreenState extends State<FutureInPastLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Future in the Past',
                  style: TextStyle(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Talking About Future Plans from a Past Perspective',
                        style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Future in the Past: Was Going To + Would',
                    content:
                    "Future in the past refers to future actions or plans viewed from a past time perspective. We use 'was/were going to' for plans and 'would' for predictions or repeated actions.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    title: 'Uses of Future in the Past',
                    examples: const [
                      Example(
                          icon: Icons.schedule,
                          category: 'Past Plans:',
                      ...
                      Example(
                          ...
                          sentence: 'She said it would rain tomorrow.'),
                      Example(
                          icon: Icons.repeat,
                          category: 'Repeated Actions:',
                          sentence: 'Every summer, we would go to the beach.'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Structures for Future in the Past',
                    headers: const ['Form', 'Use', 'Example'],
                    rows: const [
                      ['Was/Were going to + infinitive', 'Unfulfilled plans', 'I was going to study, but...'],
                      ['Would + infinitive', 'Future from past view', 'He said he would come.'],
                      ['Was/Were about to + infinitive', 'Imminent actions', 'The train was about to leave.'],
                      ['Was/Were to + infinitive', 'Formal arrangements', 'They were to meet at noon.'],
                      ['Future Continuous in Past', 'Ongoing future actions', 'This time next year, I would be working.'],
                      ['Future Perfect in Past', 'Completed by future time', 'By next week, I would have finished.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Reported Speech with Future',
                    headers: const ['Direct Speech', 'Reported Speech'],
                    rows: const [
                      ['"I will call you."', 'He said he would call me.'],
                      ['"We\'re going to visit."', 'They said they were going to visit.'],
                      ['"I\'ll be working."', 'She said she would be working.'],
                      ['"I\'ll have finished."', 'He said he would have finished.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Going To vs Would:** Going to for plans, would for predictions.',
                      '**Reported Speech:** Future becomes conditional in past.',
                      '**Time Expressions:** Use past time words with future forms.',
                      '**Practice:** Narrate past events with future references.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
          ...
          children: [
            ...
            ...tips.map((tip) => Padding(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(Icons.lightbulb, color: Colors.deepPurple.shade600, size: 20),
                  const SizedBox(width: 12),
                  Expanded(
                    child: InkWell(
                      borderRadius: BorderRadius.circular(6),
