// lib/lessons/grammar/c1/discourse_markers_lesson.dart
...
class DiscourseMarkersLessonScreen extends StatefulWidget {
  const DiscourseMarkersLessonScreen({super.key});

  @override
  State<DiscourseMarkersLessonScreen> createState() =>
      _DiscourseMarkersLessonScreenState();
}

class _DiscourseMarkersLessonScreenState extends State<DiscourseMarkersLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Discourse Markers',
                  style: TextStyle(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Connecting Ideas and Organizing Speech',
                        style: TextStyle(
            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    icon: Icons.link,
                    title: 'Discourse Markers: Linking Words and Phrases',
                    content:
                    "Discourse markers are words or phrases that help organize speech and writing, showing relationships between ideas. They include conjunctions, adverbs, and transitional phrases.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    title: 'Types of Discourse Markers',
                    examples: const [
                      Example(
                          icon: Icons.add,
                          category: 'Addition:',
                          sentence: 'Furthermore, in addition, moreover...'),
                      Example(
                          icon: Icons.compare_arrows,
                          category: 'Contrast:',
                          sentence: 'However, nevertheless, on the other hand...'),
                      Example(
                          icon: Icons.timeline,
                          category: 'Sequence:',
                          sentence: 'Firstly, subsequently, finally...'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      ['Contrast', 'However, nevertheless, on the contrary, whereas'],
                      ['Cause/Result', 'Therefore, consequently, as a result, hence'],
                      ['Example', 'For instance, such as, namely, for example'],
                      ['Time', 'Meanwhile, subsequently, eventually, finally'],
                      ['Emphasis', 'Indeed, in fact, certainly, undoubtedly'],
                      ['Concession', 'Although, even though, despite, in spite of'],
                      ['Conclusion', 'In conclusion, to sum up, overall, in brief'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Marker', 'Position', 'Example'],
                    rows: const [
                      ['However', 'Mid-sentence', 'The weather was bad. However, we went out.'],
                      ['Therefore', 'Mid-sentence', 'He studied hard. Therefore, he passed.'],
                      ['Firstly', 'Sentence start', 'Firstly, let me explain the problem.'],
                      ['In conclusion', 'Sentence start', 'In conclusion, we must act now.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Formal Writing:** Use varied markers for sophistication.',
                      '**Spoken English:** Shorter markers like "so", "but", "and".',
                      '**Avoid Overuse:** Don\'t start every sentence with them.',
                      '**Practice:** Read academic texts to see them in context.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
