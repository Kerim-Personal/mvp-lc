...
class _DiscourseMarkersLessonScreenState
    extends State<DiscourseMarkersLessonScreen> with TickerProviderStateMixin {
              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      [
                        '**Firstly**',
                        'Sentence start',
                        '***Firstly**, let me explain the problem.*'
                      ],
                      [
                        '**In conclusion**',
                        'Sentence start',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**Formal Writing:** Use varied markers like *furthermore* and *nevertheless* for sophistication.',
                      '**Spoken English:** Shorter markers like *so, but, and* are more common in informal speech.',
                      '**Avoid Overuse:** Don\'t start *every* sentence with a discourse marker; it sounds unnatural.',
                      '**Practice:** Pay attention to how these words are used in academic texts and news articles.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
