// lib/lessons/grammar/c1/nominalization_lesson.dart
...
class NominalizationLessonScreen extends StatefulWidget {
  const NominalizationLessonScreen({super.key});

  @override
  State<NominalizationLessonScreen> createState() =>
      _NominalizationLessonScreenState();
}

class _NominalizationLessonScreenState
    extends State<NominalizationLessonScreen> with TickerProviderStateMixin {
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Nominalization: Verb to Noun Conversion',
                    // Veri Markdown formatına güncellendi
                    content:
                    "**Nominalization** is the process of turning verbs or adjectives into nouns. It makes writing more **formal** and **academic** by allowing complex ideas to be expressed concisely.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    title: 'Types of Nominalization',
                    // Veri Markdown formatına güncellendi
                    examples: const [
                      Example(
                          icon: Icons.arrow_forward,
                          category: '**Verb to Noun:**',
                          sentence: '*decide → **decision**, develop → **development***'),
                      Example(
                          icon: Icons.arrow_upward,
                          category: '**Adjective to Noun:**',
                          sentence:
                          '*possible → **possibility**, responsible → **responsibility***'),
                      Example(
                          icon: Icons.merge_type,
                          category: '**Compound Nouns:**',
                          sentence: '***decision-making**, **problem-solving***'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Common Suffixes for Nominalization',
                    // Veri Markdown formatına güncellendi
                    headers: const ['**Suffix**', '**From**', '**Example**'],
                    rows: const [
                      ['**-tion/-ation**', 'Verb', '*decide → **decision***'],
                      ['**-ment**', 'Verb', '*develop → **development***'],
                      ['**-ance/-ence**', 'Adjective', '*important → **importance***'],
                      ['**-ity**', 'Adjective', '*possible → **possibility***'],
                      ['**-ness**', 'Adjective', '*happy → **happiness***'],
                      ['**-er/-or**', 'Verb', '*teach → **teacher***'],
                      ['**-ing**', 'Verb', '*swimming, reading*'],
                      ['**-al**', 'Verb', '*refusal, proposal*'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    headers: const ['**Verbal (Less Formal)**', '**Nominalized (More Formal)**'],
                    rows: const [
                      ['*They **decided**...*', '*Their **decision**...*'],
                      ['*The company **developed**...*', '*The company\'s **development**...*'],
                      ['*Scientists **discovered**...*', '*The scientists\' **discovery**...*'],
                      [
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**Academic Style:** Nominalization creates a more formal, objective, and abstract tone.',
                      '**Conciseness:** It can help combine ideas into a single noun phrase.',
                      '**Avoid Overuse:** Too much nominalization can make writing dense and hard to read. Balance it with active verbs.',
                      '**Practice:** Try converting sentences from verbal to nominalized form and vice versa.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
