              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    content:
                    "**Inversion** involves reversing the usual subject-verb word order for **emphasis**, **formality**, or in certain structures. It's common with negative adverbs, conditionals, and questions.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      ['**Had** (Type 3)', '***Had** I known, I would have come.*'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**Emphasis:** Inversion adds a strong emphasis or dramatic effect.',
                      '**Negative Adverbs:** Must be at the *start* of the sentence to trigger inversion. (e.g., *Never, Rarely, Scarcely, Hardly*).',
                      '**Formal Writing:** This is very common in literature and formal English, less common in casual speech.',
                      '**Auxiliary Verb:** Inversion happens with the auxiliary verb (*do, does, did, have, had, will, would, etc.*).',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
