// lib/lessons/grammar/c1/inversion_lesson.dart
...
class InversionLessonScreen extends StatefulWidget {
  const InversionLessonScreen({super.key});

  @override
  State<InversionLessonScreen> createState() =>
      _InversionLessonScreenState();
}

class _InversionLessonScreenState extends State<InversionLessonScreen>
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Reversing Word Order for Emphasis',
                        style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Inversion: Subject-Verb Reversal',
                    content:
                    "Inversion involves reversing the usual subject-verb word order for emphasis, formality, or in certain structures. Common with negative adverbs, conditionals, and exclamations.",
                    onSpeak: _speak,
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      ...
                      Example(
                          ...
                          category: 'Questions:',
                          sentence: 'Had you finished when I arrived?'),
                      Example(
                          icon: Icons.warning,
                          category: 'Conditionals:',
                          sentence: 'Should you need help, call me.'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Common Inversion Structures',
                    headers: const ['Trigger', 'Normal Order', 'Inverted Order'],
                    rows: const [
                      ['Never', 'I have never seen...', 'Never have I seen...'],
                      ['Rarely', 'She rarely speaks...', 'Rarely does she speak...'],
                      ['No sooner', 'He had no sooner...', 'No sooner had he...'],
                      ['Only then', 'I realized only then...', 'Only then did I realize...'],
                      ['So...that', 'He was so tired...', 'So tired was he...'],
                      ['Such...that', 'It was such a...', 'Such was the...'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ['Should', 'Should you change your mind, let me know.'],
                      ['Were', 'Were I rich, I would travel the world.'],
                      ['Had', 'Had I known, I would have come.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Emphasis:** Inversion adds emphasis and formality.',
                      '**Negative Words:** Never, rarely, scarcely, hardly, etc.',
                      '**Formal Writing:** Common in literature and formal English.',
                      '**Avoid Overuse:** Use sparingly to avoid sounding unnatural.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
