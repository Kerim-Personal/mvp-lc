// lib/lessons/grammar/c1/cleft_sentences_lesson.dart
...
class CleftSentencesLessonScreen extends StatefulWidget {
  const CleftSentencesLessonScreen({super.key});

  @override
  State<CleftSentencesLessonScreen> createState() =>
      _CleftSentencesLessonScreenState();
}

class _CleftSentencesLessonScreenState extends State<CleftSentencesLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Cleft Sentences',
                  style: TextStyle(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Splitting Sentences for Emphasis',
                        style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Cleft Sentences: It + Be + Focus',
                    // Veri Markdown formatına güncellendi
                    content:
                    "Cleft sentences split a simple sentence into two parts to **emphasize** a particular element. They use **'It is/was'** or **'What'** to focus on the important information.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    title: 'Types of Cleft Sentences',
                    // Veri Markdown formatına güncellendi
                    examples: const [
                      Example(
                          icon: Icons.lightbulb,
                          category: '**It-Cleft (Subject Focus):**',
                          sentence: '*It was **John** who broke the window.*'),
                      Example(
                          icon: Icons.access_time,
                          category: '**It-Cleft (Object Focus):**',
                          sentence: '*It was **the window** that John broke.*'),
                      Example(
                          icon: Icons.question_answer,
                          category: '**Wh-Cleft (What):**',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'It-Cleft Structures',
                    // Veri Markdown formatına güncellendi
                    headers: const ['**Focus**', '**Original**', '**Cleft Sentence**'],
                    rows: const [
                      ['Subject', '*John* broke the window.', '*It was **John** who broke the window.*'],
                      ['Object', 'John broke *the window*.', '*It was **the window** that John broke.*'],
                      ['Time', 'I met him *yesterday*.', '*It was **yesterday** that I met him.*'],
                      [
                        'Place',
                        'I saw him *in the park*.',
                        '*It was **in the park** that I saw him.*'
                      ],
                      ['Manner', 'He spoke *angrily*.', '*It was **angrily** that he spoke.*'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      ['**All + Relative**', '*All he does **is complain**.*'],
                      [
                        '**The thing/place/time**',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Emphasis:** Clefts are all about highlighting one piece of information as the most important.',
                      '**Formality:** Cleft sentences are very common in spoken English but also used in formal writing for clarity.',
                      '**Avoid Overuse:** Use them for emphasis, not in every sentence, as it can sound unnatural.',
                      '**Relative Pronouns:** \'It-clefts\' use *who, that, which, when, where*. \'Wh-clefts\' start with *What*.', // Düzeltildi
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
