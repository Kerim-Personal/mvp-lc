// lib/lessons/grammar/c1/idioms_lesson.dart
...
class IdiomsLessonScreen extends StatefulWidget {
  const IdiomsLessonScreen({super.key});

  @override
  State<IdiomsLessonScreen> createState() =>
      _IdiomsLessonScreenState();
}

class _IdiomsLessonScreenState extends State<IdiomsLessonScreen>
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Idioms: Fixed Figurative Expressions',
                    content:
                    "Idioms are fixed expressions where the meaning cannot be deduced from the individual words. They add color and expressiveness to language, but must be learned as whole units.",
                    onSpeak: _speak,
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          sentence: 'Kick the bucket (die), spill the beans (reveal secret)'),
                      Example(
                          icon: Icons.mood,
                          category: 'Emotions:',
                          sentence: 'Hit the roof (get angry), bite your tongue (stay silent)'),
                      Example(
                          icon: Icons.work,
                          category: 'Work/Business:',
                          sentence: 'Burn the midnight oil (work late), call it a day (finish work)'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Idioms by Theme',
                    headers: const ['Theme', 'Examples'],
                    rows: const [
                      ['Money', 'Break the bank, cost an arm and a leg, pay through the nose'],
                      ['Success', 'Hit the jackpot, strike gold, make it big'],
                      ['Problems', 'In hot water, up the creek, between a rock and a hard place'],
                      ['Relationships', 'On cloud nine, head over heels, tie the knot'],
                      ['Communication', 'Beat around the bush, get the message, read between the lines'],
                      ['Food', 'Piece of cake, spill the beans, bring home the bacon'],
                      ['Animals', 'Stool pigeon, loan shark, busy as a bee'],
                      ['Body Parts', 'Keep an eye on, lend a hand, foot the bill'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Idiom', 'Meaning', 'Example'],
                    rows: const [
                      ['Break a leg', 'Good luck', 'Break a leg in your exam!'],
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Learn in Context:** Study idioms with example sentences.',
                      '**Don\'t Translate Literally:** Idioms don\'t make sense word-for-word.',
                      '**Practice Moderately:** Use idioms naturally, not excessively.',
                      '**Cultural Awareness:** Some idioms are culture-specific.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
