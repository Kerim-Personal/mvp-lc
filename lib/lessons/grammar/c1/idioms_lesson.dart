              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          sentence:
                          '***Kick the bucket*** (die), ***spill the beans*** (reveal secret)'),
                      Example(
                          icon: Icons.mood,
                          category: '**Emotions:**',
                          sentence:
                          '***Hit the roof*** (get angry), ***bite your tongue*** (stay silent)'),
                      Example(
                          icon: Icons.work,
                          category: '**Work/Business:**',
                          sentence:
                          '***Burn the midnight oil*** (work late), ***call it a day*** (finish work)'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      [
                        '**Money**',
                        '*Break the bank, cost an arm and a leg, pay through the nose*'
                      ],
                      ['**Success**', '*Hit the jackpot, strike gold, make it big*'],
                      [
                        '**Problems**',
                        '*In hot water, up the creek, between a rock and a hard place*'
                      ],
                      [
                        '**Relationships**',
                        '*On cloud nine, head over heels, tie the knot*'
                      ],
                      [
                        '**Communication**',
                        '*Beat around the bush, get the message, read between the lines*'
                      ],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**Learn in Context:** Study idioms with example sentences, not just lists.',
                      '**Don\'t Translate Literally:** Idioms don\'t make sense word-for-word.',
                      '**Practice Moderately:** Use idioms naturally, not excessively, to sound fluent.',
                      '**Cultural Awareness:** Some idioms are very specific to one culture (e.g., American vs. British English).',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
