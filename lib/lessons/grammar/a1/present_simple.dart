...
class PresentSimpleLessonScreen extends StatefulWidget {
  ...
  @override
  State<PresentSimpleLessonScreen> createState() =>
      _PresentSimpleLessonScreenState();
}

class _PresentSimpleLessonScreenState extends State<PresentSimpleLessonScreen>
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    content:
                    "The Present Simple tense helps us talk about things that happen regularly, or are generally true. It's how you describe your daily habits, permanent situations, and facts about the world. Think of it as your 'daily routine' tense!",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    title: 'Habits, Facts, and Routines',
                    examples: const [
                      Example(
                          icon: Icons.repeat,
                      ...
                      Example(
                          ...
                          category: 'Permanent Situation:',
                          sentence: 'He lives in New York.'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ['I / You / We / They', 'work', 'We work in an office.'],
                      ['He / She / It', 'works', 'She works very hard.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Negative Sentences: Use "don\'t" or "doesn\'t"',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Question Sentences: Use "Do" or "Does"',
                    headers: const ['Question', 'Short Answer'],
                    rows: const [
                      ['Do you speak English?', 'Yes, I do.'],
                      ['Does he play sports?', 'No, he doesn\'t.'],
                      ['Do they live here?', 'Yes, they do.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Third-person singular is special!** For **he, she, it**, we add **-s** or **-es** to the end of the verb. For example: He watch**es** TV. She go**es** to school.',
                      "**'Do' and 'Does' are for questions and negatives.** Remember that the main verb doesn't change when you use 'do' or 'does'. For example: Does he **work**? (NOT 'works').",
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            Icon(Icons.volume_up_outlined, color: Colors.indigo.shade400, size: 20),
            const SizedBox(width: 8),
            Expanded(
              child: Text(
