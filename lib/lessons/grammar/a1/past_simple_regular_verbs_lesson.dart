...
class PastSimpleRegularVerbsLessonScreen extends StatefulWidget {
  ...
  @override
  State<PastSimpleRegularVerbsLessonScreen> createState() => _PastSimpleRegularVerbsLessonScreenState();
}

class _PastSimpleRegularVerbsLessonScreenState extends State<PastSimpleRegularVerbsLessonScreen> with TickerProviderStateMixin {
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Past Simple (Regular Verbs)', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.white)),
              background: Container(
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                    colors: [Colors.brown.shade500, Colors.orange.shade800],
                  ),
                ),
                child: const Center(
                  child: Icon(Icons.replay_outlined, size: 80, color: Colors.white24),
                ),
              ),
            ),
          ),
              ...
              delegate: SliverChildListDelegate([
                _AnimatedLessonBlock(
                  ...
                  child: const _LessonBlock(
                    ...
                    title: 'Geçmişteki Eylemler: Düzenli Fiiller',
                    content:
                    "Geçmişte başlayıp bitmiş eylemleri anlatmak için Past Simple (Geçmiş Zaman) kullanırız. İngilizcedeki fiillerin çoğu düzenlidir ve geçmiş zamanda kullanılmak için sonlarına '-ed' takısı alırlar. Bu basit kuralla geçmişteki anılarınızı ve olayları anlatmaya başlayabilirsiniz!",
                  ),
                ),
                _AnimatedLessonBlock(
                  controller: _controller,
                  ...
                  child: _ExampleCard(
                    ...
                    examples: [
                      ...
                      Example(
                          ...
                          category: 'İzledi:',
                          sentence: 'He watched a movie last night.'),
                      Example(
                          icon: Icons.cleaning_services_outlined,
                          category: 'Temizlediler:',
                          sentence: 'They cleaned the house on Saturday.'),
                    ],
                  ),
                ),
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleTable(
                    title: 'Olumsuz ve Soru Cümleleri: "did"',
                    headers: const ['Cümle Tipi', 'Kural', 'Örnek'],
                    rows: const [
                      ['Olumsuz (-)', 'Özne + did not (didn\'t) + Fiil (yalın)', 'She didn\'t play tennis.'],
                      ['Soru (?)', 'Did + Özne + Fiil (yalın)?', 'Did you visit your grandparents?'],
                    ],
                  ),
                ),
                _AnimatedLessonBlock(
                  ...
                  child: const _LessonBlock(
                    ...
                    title: '"-ed" Ekleme Kuralları',
                    content:
                    "Çoğu fiil sadece '-ed' alsa da birkaç küçük yazım kuralı vardır:\n\n• 'e' ile biten fiiller: Sadece '-d' eklenir. (live → lived)\n\n• Sessiz + 'y': 'y' düşer, '-ied' gelir. (study → studied)\n\n• Sesli + 'y': Sadece '-ed' eklenir. (play → played)\n\n• Tek heceli (sessiz-sesli-sessiz): Son harf tekrarlar. (stop → stopped)",
                  ),
                ),
                _AnimatedLessonBlock(
                  controller: _controller,
                  ...
                  child: const _TipCard(
                    ...
                    tips: [
                      '**"did" Varsa "-ed" Yoktur:** Olumsuz cümlelerde ve sorularda yardımcı fiil "did" kullanıldığı için, ana fiil yalın halde kalır, yani "-ed" takısı almaz. Bu en önemli kuraldır!',
                      '**Zaman Zarfları:** "yesterday", "last week", "two days ago" gibi geçmiş zaman belirten zarflar, cümlenin genellikle en sonunda yer alır.',
                    ],
                  ),
                ),
        ...
        child: Column(
          ...
          children: [
            ...
            ...examples.map((e) => Padding(
              ...
              child: Row(
                children: [
                  Icon(e.icon, size: 22, color: Colors.brown),
                  const SizedBox(width: 12),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            const SizedBox(height: 16),
            _QuizQuestion(
              question: '1. I ___ the door.',
              options: const ['close', 'closed', 'closing'],
            ...
            _QuizQuestion(
              question: '2. She ___ the question.',
              options: const ["didn't answer", "not answered", "don't answer"],
            ...
            _QuizQuestion(
              question: '3. ___ you ___ the film?',
              options: const ['Did / liked', 'Do / liked', 'Did / like'],
