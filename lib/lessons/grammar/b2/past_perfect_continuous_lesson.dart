// lib/lessons/grammar/b2/past_perfect_continuous_lesson.dart
...
class PastPerfectContinuousLessonScreen extends StatefulWidget {
  const PastPerfectContinuousLessonScreen({super.key});

  @override
  State<PastPerfectContinuousLessonScreen> createState() =>
      _PastPerfectContinuousLessonScreenState();
}

class _PastPerfectContinuousLessonScreenState extends State<PastPerfectContinuousLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Past Perfect Continuous',
                  style: TextStyle(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Actions Continuing Before Another Past Action',
                        style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    content:
                    "The Past Perfect Continuous describes an action that started in the past and continued up to another point in the past. It emphasizes duration. Form: had been + verb-ing. Often used with 'for' and 'since' to show how long.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    title: 'When to Use Past Perfect Continuous',
                    examples: const [
                      Example(
                          icon: Icons.access_time,
                          category: 'Duration Before Past Event:',
                          sentence: 'She had been studying for 3 hours when I called.'),
                      Example(
                          icon: Icons.water_drop,
                          category: 'Cause of Present Result:',
                          sentence: 'The ground was wet because it had been raining.'),
                      Example(
                          icon: Icons.repeat,
                          category: 'Repeated Actions:',
                          sentence: 'He had been practicing the piano every day.'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Structure: Had Been + Verb-ing',
                    headers: const ['Subject', 'Had Been', 'Verb-ing', 'Time Expression', 'Full Sentence'],
                    rows: const [
                      ['I', 'had been', 'working', 'for 2 hours', 'I had been working for 2 hours.'],
                      ['She', 'had been', 'living', 'in London since 2010', 'She had been living in London since 2010.'],
                      ['They', 'had been', 'waiting', 'for an hour', 'They had been waiting for an hour.'],
                      ['We', 'had been', 'traveling', 'all day', 'We had been traveling all day.'],
                      ['He', 'had been', 'sleeping', 'when the phone rang', 'He had been sleeping when the phone rang.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ['Negative', 'I hadn\'t been sleeping.', 'No, I hadn\'t.'],
                      ['Question', 'Had you been working?', 'Yes, I had.'],
                      ['Wh-Question', 'How long had you been waiting?', 'For 30 minutes.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Duration Focus:** Emphasizes how long an action continued.',
                      '**Time Expressions:** Use with "for" (period) and "since" (point).',
                      '**Past Perfect Simple vs Continuous:** Simple for completed actions, continuous for ongoing.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
