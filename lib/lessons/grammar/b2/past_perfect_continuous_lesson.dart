...
class _PastPerfectContinuousLessonScreenState
    extends State<PastPerfectContinuousLessonScreen>
              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          sentence:
                          '*She **had been studying** for 3 hours when I *called*.*'),
                      Example(
                          icon: Icons.water_drop,
                          category: '**Cause of a Past Result:**',
                          sentence:
                          '*The ground *was* wet because it **had been raining**.*'),
                      Example(
                          icon: Icons.repeat,
                          category: '**Repeated Actions (before past):**',
                          sentence:
                          '*He **had been practicing** the piano every day before the concert.*'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      [
                        ...
                        '*She **had been living** in London since 2010.*'
                      ],
                      [
                        'They',
                        '**had been**',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**Duration Focus:** This tense strongly emphasizes **how long** an action continued before another past event.',
                      '**Time Expressions:** Use with "**for**" (a period of time) and "**since**" (a point in time).',
                      '**Past Perfect Simple vs Continuous:** **Simple** (*had finished*) focuses on the *completion/result*. **Continuous** (*had been finishing*) focuses on the *duration* of the activity.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
