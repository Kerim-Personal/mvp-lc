// lib/lessons/grammar/b2/reported_speech_all_lesson.dart
...
class ReportedSpeechAllLessonScreen extends StatefulWidget {
  const ReportedSpeechAllLessonScreen({super.key});

  @override
  State<ReportedSpeechAllLessonScreen> createState() =>
      _ReportedSpeechAllLessonScreenState();
}

class _ReportedSpeechAllLessonScreenState
    extends State<ReportedSpeechAllLessonScreen> with TickerProviderStateMixin {
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Reported Speech (All)',
                  style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Reported Speech: Changes in Tense and Structure',
                    // Veri Markdown formatına güncellendi
                    content:
                    "Reported speech is used to tell what someone said *without* using their exact words. We make changes to **pronouns**, **tenses** (backshifting), and **time expressions**. The reporting verb (said/told) is usually in the past.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      ['*"I **have finished**."*', '*They said (that) they **had finished**.*'],
                      ['*"I **can** swim."*', '*She said (that) she **could** swim.*'],
                      ['*"I **must** go."*', '*He said (that) he **had to** go.*'],
                      ['*"I **may** come."*', '*They said (that) they **might** come.*'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      ...
                      Example(
                          ...
                          sentence: '*\"Yes, I do.\" → He said that he **did**.*'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**"Say" vs "Tell":** "Said" doesn\'t need an object (*He said...*). "Told" **must** have an object (*He told **me**...*).',
                      '**No Tense Change:** For general truths or things that are still true, tenses may not change. (*"The sky **is** blue." → He said the sky **is** blue.*)',
                      '**Modal Changes:** **can** → **could**, **may** → **might**, **will** → **would**. (**should, could, might, ought to** usually don\'t change).',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
...
class _SpeechHintBox extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Renkler bu dersin temasına (mavi-gri) uyacak şekilde düzeltildi
    final isDark = Theme.of(context).brightness == Brightness.dark;
    return Container(
      margin: const EdgeInsets.only(bottom: 24),
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: isDark ? Colors.blueGrey.shade900.withOpacity(0.3) : Colors.blueGrey.shade50,
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(example.icon, color: Colors.blueGrey.shade600, size: 24),
          const SizedBox(width: 12),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
