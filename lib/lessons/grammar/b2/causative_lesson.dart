              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      ...
                      Example(
                          ...
                          sentence:
                          '*She **has her hair cut** every six weeks.*'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**"Have" vs "Get":** "Have" is slightly more formal. "Get" is more casual and common in speech.',
                      '**Cost:** This structure often implies paying for a professional service.',
                      '**Passive Feel:** The subject of the sentence (I, She, We) is *not* the one doing the action (repairing, painting, cutting).',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
        ...
        child: Column(
          ...
          children: [
            ...
            SingleChildScrollView(
              ...
              child: DataTable(
                // Orijinal dosyadaki stiller kaldırıldı
                columns: headers
                    .map((h) => DataColumn(
                  label: InkWell(
                    onTap: () => onSpeak(h),
