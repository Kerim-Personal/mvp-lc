// lib/lessons/grammar/b2/modals_deduction_lesson.dart
...
class ModalsDeductionLessonScreen extends StatefulWidget {
  const ModalsDeductionLessonScreen({super.key});

  @override
  State<ModalsDeductionLessonScreen> createState() =>
