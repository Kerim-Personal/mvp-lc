// lib/lessons/grammar/b2/participle_clauses_lesson.dart
...
class ParticipleClausesLessonScreen extends StatefulWidget {
  const ParticipleClausesLessonScreen({super.key});

  @override
  State<ParticipleClausesLessonScreen> createState() =>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Participle Clauses',
                  style: TextStyle(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Reducing Clauses with -ing and -ed',
                        style: TextStyle(
