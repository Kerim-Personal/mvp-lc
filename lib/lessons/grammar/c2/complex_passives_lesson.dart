// lib/lessons/grammar/c1/complex_passives_lesson.dart
...
class ComplexPassivesLessonScreen extends StatefulWidget {
  ...
  @override
  State<ComplexPassivesLessonScreen> createState() =>
      _ComplexPassivesLessonScreenState();
}

class _ComplexPassivesLessonScreenState
    extends State<ComplexPassivesLessonScreen> with TickerProviderStateMixin {
              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          category: '**Can/Must/May + be + PP:**',
                          sentence: '*The report **can be submitted** online.*'),
                      Example(
                          icon: Icons.warning_outlined,
                          category: '**Should + be + PP:**',
                          sentence:
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      [
                        '**Will + have + been + PP**',
                        '*The results **will have been analyzed**...*'
                      ],
                      [
                        '**Would + have + been + PP**',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    // Veri Markdown formatına güncellendi
                    content:
                    "Passives can be formed with gerunds and infinitives. \n\n* **Gerund:** ***Being invited** to the conference was an honor.*\n* **Infinitive:** *The book is expected **to be published** soon.*\n\nThese structures are used in formal contexts to express necessity, expectation, or ongoing actions.",
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ),
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi - HATALI SATIR DÜZELTİLDİ
                    tips: const [
                      ...
                      '**"Get" Passive (Informal):** In casual speech, **\'get\'** is often used instead of **\'be\'**. (e.g., *I **got** fired.* / *He **got** hurt.*)',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
