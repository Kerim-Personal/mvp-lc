// lib/lessons/grammar/c2/complex_passives_lesson.dart
...
class ComplexPassivesLessonScreen extends StatefulWidget {
  const ComplexPassivesLessonScreen({super.key});

  @override
  State<ComplexPassivesLessonScreen> createState() => _ComplexPassivesLessonScreenState();
}

class _ComplexPassivesLessonScreenState extends State<ComplexPassivesLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Complex Passives',
                  style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'What are Complex Passives?',
                    content:
                    "Complex passives involve passive voice structures that are more advanced, often using modal verbs, perfect tenses, or gerunds. They are common in formal writing, academic texts, and reports where the focus is on the action rather than the doer.",
                    onSpeak: _speak,
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          category: 'Can/Must/May + be + past participle:',
                          sentence: 'The report can be submitted online.'),
                      Example(
                          icon: Icons.warning_outlined,
                          category: 'Should + be + past participle:',
                          sentence: 'The equipment should be checked regularly.'),
                      Example(
                          icon: Icons.access_time_outlined,
                          category: 'Will + be + past participle:',
                          sentence: 'The project will be completed next month.'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Perfect Passives',
                    headers: const ['Structure', 'Example'],
                    rows: const [
                      ['Have/Has + been + past participle', 'The bridge has been repaired.'],
                      ['Had + been + past participle', 'The documents had been signed before the meeting.'],
                      ['Will + have + been + past participle', 'The results will have been analyzed by Friday.'],
                      ['Would + have + been + past participle', 'The issue would have been resolved earlier.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Gerund and Infinitive Passives',
                    content:
                    "Passives can be formed with gerunds and infinitives. For example: 'Being invited to the conference was an honor.' or 'The book is expected to be published soon.' These structures are used in formal contexts to express necessity, expectation, or ongoing actions.",
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ),
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      "**Focus on the Action:** Use passives when the doer is unknown, unimportant, or obvious. This shifts emphasis to the result or process.",
                      "**Avoid Overuse:** While passives are useful in formal writing, active voice is often clearer and more direct in everyday communication.",
                      "**Check for Clarity:** Ensure that passive sentences don't become too complex. If the meaning is unclear, consider rephrasing.",
                      "**Practice with News:** Read newspaper articles and identify passive structures. Try converting them to active voice to understand the difference.",
                      "**Common Mistakes:** Don't forget the auxiliary verbs (be, have been) and ensure the past participle is correct.",
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
