...
class AmbiguityLessonScreen extends StatefulWidget {
  const AmbiguityLessonScreen({super.key});

  @override
  State<AmbiguityLessonScreen> createState() => _AmbiguityLessonScreenState();
}

class _AmbiguityLessonScreenState extends State<AmbiguityLessonScreen>
