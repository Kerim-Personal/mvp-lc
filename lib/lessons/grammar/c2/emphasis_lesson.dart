...
class EmphasisLessonScreen extends StatefulWidget {
  const EmphasisLessonScreen({super.key});

  @override
  State<EmphasisLessonScreen> createState() => _EmphasisLessonScreenState();
}

class _EmphasisLessonScreenState extends State<EmphasisLessonScreen>
