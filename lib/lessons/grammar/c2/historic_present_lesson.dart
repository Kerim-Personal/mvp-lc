// lib/lessons/grammar/c2/historic_present_lesson.dart
...
class HistoricPresentLessonScreen extends StatefulWidget {
  const HistoricPresentLessonScreen({super.key});

  @override
  State<HistoricPresentLessonScreen> createState() => _HistoricPresentLessonScreenState();
}

class _HistoricPresentLessonScreenState extends State<HistoricPresentLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Historic Present',
                  style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'What is Historic Present?',
                    content:
                    "Historic present is the use of present tense verbs to describe past events. It makes stories more vivid and engaging, as if the events are happening now. This technique is common in storytelling, news reporting, and literary narratives.",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    title: 'When to Use Historic Present',
                    examples: const [
                      Example(
                          icon: Icons.book_outlined,
                          category: 'Storytelling:',
                          sentence: 'The hero grabs his sword and charges into battle.'),
                      Example(
                          icon: Icons.article_outlined,
                          category: 'News Reports:',
                          sentence: 'The president announces new policies yesterday.'),
                      Example(
                          icon: Icons.theater_comedy_outlined,
                          category: 'Sports Commentary:',
                          sentence: 'The striker kicks the ball and scores!'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Historic Present Examples',
                    headers: const ['Past Tense', 'Historic Present'],
                    rows: const [
                      ['He walked into the room.', 'He walks into the room.'],
                      ['They discovered the treasure.', 'They discover the treasure.'],
                      ['The king died in 1066.', 'The king dies in 1066.'],
                      ['She wrote the letter.', 'She writes the letter.'],
                      ['We arrived at the station.', 'We arrive at the station.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    content:
                    "Don't use historic present for all verbs in a narrative, as it can become confusing. Reserve it for key actions or sequences. Also, avoid it in formal academic writing where past tense is preferred for objectivity.",
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ),
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      "**Create Vividness:** Historic present makes past events feel immediate and exciting, drawing readers into the story.",
                      "**Mix Tenses:** Combine historic present with past tense for background information to maintain clarity.",
                      "**Practice with Books:** Read novels or biographies that use historic present, like 'The Great Gatsby' or sports reports.",
                      "**Be Consistent:** Within a sequence of events, stick to historic present, but switch back to past for non-action descriptions.",
                      "**Cultural Variation:** More common in English than some other languages; use it to add dynamism to your writing.",
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
