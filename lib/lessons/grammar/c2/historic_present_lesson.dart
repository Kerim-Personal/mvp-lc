// lib/lessons/grammar/c1/historic_present_lesson.dart
...
class HistoricPresentLessonScreen extends StatefulWidget {
  ...
  @override
  State<HistoricPresentLessonScreen> createState() =>
      _HistoricPresentLessonScreenState();
}

class _HistoricPresentLessonScreenState
    extends State<HistoricPresentLessonScreen> with TickerProviderStateMixin {
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    content:
                    "The **historic present** is the use of **present tense** verbs to describe **past events**. It makes stories more **vivid** and **engaging**, as if the events are happening right now. This technique is common in storytelling, news reporting, and literary narratives.",
                    onSpeak: _speak,
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          sentence:
                          '*The hero **grabs** his sword and **charges** into battle.*'),
                      Example(
                          icon: Icons.article_outlined,
                          category: '**News Reports (Headlines):**',
                          sentence: '*The president **announces** new policies.*'),
                      Example(
                          icon: Icons.theater_comedy_outlined,
                          category: '**Sports Commentary:**',
                          sentence: '*He **kicks** the ball and **scores**!*'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    // Veri Markdown formatına güncellendi
                    content:
                    "Don't use the historic present for *all* verbs in a narrative, as it can become confusing. Reserve it for **key actions** or sequences. Also, avoid it in formal academic writing where past tense is preferred for objectivity.",
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ),
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      ...
                      "**Mix Tenses:** Combine historic present (for action) with past tense (for background information) to maintain clarity.",
                      "**Be Consistent:** Within a specific sequence of events, try to stick to the historic present for flow.",
                      "**Practice:** Read novels or biographies that use this style. Sports reports are also a great place to see it in action.",
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
