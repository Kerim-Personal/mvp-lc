// lib/lessons/grammar/a2/past_continuous.dart
...
class PastContinuousLessonScreen extends StatefulWidget {
  const PastContinuousLessonScreen({super.key});

  @override
  State<PastContinuousLessonScreen> createState() => _PastContinuousLessonScreenState();
}

class _PastContinuousLessonScreenState extends State<PastContinuousLessonScreen>
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: 'Past Continuous: Was/Were + Verb-ing',
                    content:
                    "The past continuous describes actions that were in progress at a specific time in the past. It's formed with 'was/were' + verb-ing. Perfect for setting scenes, describing interrupted actions, and talking about temporary situations in the past.",
                    onSpeak: _speak,
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          category: 'Ongoing actions at specific time:',
                          sentence: 'At 3 PM yesterday, I was studying.'),
                      Example(
                          icon: Icons.pause,
                      ...
                      Example(
                          ...
                          category: 'Temporary situations:',
                          sentence: 'Last year, she was living in Paris.'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Subject', 'Was/Were', 'Verb-ing', 'Example'],
                    rows: const [
                      ['I / He / She / It', 'was', 'working', 'I was working.'],
                      ['You / We / They', 'were', 'working', 'You were working.'],
                      ['I / He / She / It', 'was', 'eating', 'She was eating.'],
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ['Was I running?', 'Yes, you were.'],
                      ['Were you sleeping?', 'No, I wasn\'t.'],
                      ['Was she working?', 'Yes, she was.'],
                      ['Were they eating?', 'No, they weren\'t.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**With "while" and "when":** "I was cooking while she was sleeping."',
                      '**Past continuous + past simple:** "I was walking when I saw him." (interruption)',
                      '**Background actions:** "It was raining when we left." (setting the scene)',
                      '**Two actions:** "While I was studying, my brother was playing games."',
                      '**Don\'t use with stative verbs:** Love, know, believe, etc. use past simple.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        children: [
            Row(
              children: [
                Icon(Icons.lightbulb_outline, color: Colors.brown.shade700, size: 28),
                const SizedBox(width: 14),
                Expanded(
                  child: InkWell(
                    borderRadius: BorderRadius.circular(6),
            ...
            ...examples.map((example) => Padding(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(example.icon, color: Colors.brown.shade600, size: 24),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.table_chart_outlined, color: Colors.brown.shade700, size: 28),
                const SizedBox(width: 14),
                Expanded(
                  child: InkWell(
                    borderRadius: BorderRadius.circular(6),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.tips_and_updates_outlined, color: Colors.brown.shade700, size: 28),
                const SizedBox(width: 14),
                Expanded(
                  child: InkWell(
                    borderRadius: BorderRadius.circular(6),
