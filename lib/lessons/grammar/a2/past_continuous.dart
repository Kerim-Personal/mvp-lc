...
class PastContinuousLessonScreen extends StatefulWidget {
  ...
  @override
  State<PastContinuousLessonScreen> createState() =>
      _PastContinuousLessonScreenState();
}
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          sentence:
                          '*At 3 PM yesterday, I **was studying**.*'),
                      Example(
                          icon: Icons.pause,
                      ...
                      Example(
                          ...
                          sentence:
                          '*Last year, she **was living** in Paris.*'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      ...
                      '**Don\'t use with stative verbs:** (e.g., *love, know, believe*). Use Past Simple instead.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
...
class _SpeechHintBox extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // Renkler bu dersin temasına (kahverengi/turuncu) uyacak şekilde düzeltildi
    return Container(
      ...
      child: Row(
        children: [
          Icon(Icons.volume_up, color: Colors.brown.shade700),
            ...
            ...examples.map((example) => Padding(
              ...
              child: InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    Icon(example.icon,
                        color: Colors.brown.shade600, size: 24),
                    const SizedBox(width: 12),
                    Expanded(
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
