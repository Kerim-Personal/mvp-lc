// lib/lessons/grammar/a2/be_going_to.dart
...
class BeGoingToLessonScreen extends StatefulWidget {
  const BeGoingToLessonScreen({super.key});

  @override
  State<BeGoingToLessonScreen> createState() => _BeGoingToLessonScreenState();
}

class _BeGoingToLessonScreenState extends State<BeGoingToLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('"Be Going To" for Future',
                  style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    title: '"Be Going To": Future Plans and Predictions',
                    content:
                    "'Be going to' expresses future plans that are already decided, or predictions based on current evidence. It's formed with 'be' + 'going to' + infinitive. Great for talking about intentions and expectations!",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          icon: Icons.schedule,
                          category: 'Future Plans (decided):',
                          sentence: 'I am going to study tonight.'),
                      Example(
                          icon: Icons.visibility,
                          category: 'Predictions (evidence):',
                          sentence: 'It is going to rain. (dark clouds)'),
                      Example(
                          icon: Icons.warning,
                          category: 'Warnings:',
                          sentence: 'You are going to be late!'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Subject', 'Form', 'Example Sentence'],
                    rows: const [
                      ['I', 'am going to + verb', 'I am going to learn Spanish.'],
                      ['He / She / It', 'is going to + verb', 'She is going to buy a car.'],
                      ['You / We / They', 'are going to + verb', 'We are going to travel next year.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ['I am not going to study.', "I'm not going to study."],
                      ['He is not going to come.', "He isn't going to come."],
                      ['They are not going to wait.', "They aren't going to wait."],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      ['Is she going to help?', 'Yes, she is.'],
                      ['Are they going to leave?', 'No, they aren\'t.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Plans vs Will:** Use "going to" for planned actions, "will" for spontaneous decisions.',
                      '**Evidence for predictions:** "Look at those clouds. It\'s going to rain."',
                      '**Contractions:** "I\'m going to", "She\'s going to", "We\'re going to"',
                      '**Time expressions:** Tomorrow, next week, this evening, etc.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
    ...
    return Card(
      ...
      child: Padding(
        ...
        children: [
            Row(
              children: [
                Icon(Icons.lightbulb_outline, color: Colors.pink.shade700, size: 28),
                const SizedBox(width: 14),
                Expanded(
                  child: InkWell(
                    borderRadius: BorderRadius.circular(6),
            ...
            ...examples.map((example) => Padding(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(example.icon, color: Colors.pink.shade600, size: 24),
                  const SizedBox(width: 12),
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.table_chart_outlined, color: Colors.pink.shade700, size: 28),
                const SizedBox(width: 14),
                Expanded(
                  child: InkWell(
                    borderRadius: BorderRadius.circular(6),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            Row(
              children: [
                Icon(Icons.tips_and_updates_outlined, color: Colors.pink.shade700, size: 28),
                const SizedBox(width: 14),
                Expanded(
                  child: InkWell(
                    borderRadius: BorderRadius.circular(6),
            ...
            ...tips.map((tip) => Padding(
              ...
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Icon(Icons.check_circle_outline, color: Colors.pink.shade600, size: 20),
                  const SizedBox(width: 12),
                  Expanded(
                    child: InkWell(
                      borderRadius: BorderRadius.circular(6),
