...
class PresentPerfectLessonScreen extends StatefulWidget {
  ...
  @override
  State<PresentPerfectLessonScreen> createState() => _PresentPerfectLessonScreenState();
}

class _PresentPerfectLessonScreenState extends State<PresentPerfectLessonScreen>
              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          sentence: 'I have visited Paris. (at some time in my life)'),
                      Example(
                          icon: Icons.update,
                          category: 'Unfinished actions:',
                          sentence: 'She has lived here for 5 years. (still lives here)'),
                      Example(
                          icon: Icons.done_all,
                          category: 'Completed with present result:',
                          sentence: 'I have finished my homework. (it\'s done now)'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Subject', 'Have/Has', 'Past Participle', 'Example'],
                    rows: const [
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      ...
                      '**With "since" and "for":** "I have lived here for 3 years." "Since 2010."',
                      '**Just vs already/yet:** "Have you eaten yet?" "I have already eaten."',
                      '**Ever/never:** "Have you ever been to Japan?" "I have never been."',
                      '**Present perfect vs past simple:** "I ate breakfast." (past) vs "I have eaten." (today)',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
