...
class PastPerfectLessonScreen extends StatefulWidget {
  ...
  @override
  State<PastPerfectLessonScreen> createState() =>
      _PastPerfectLessonScreenState();
}
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      ...
                      Example(
                          icon: Icons.history,
                          category: '**Experiences (before a past time):**',
                          sentence: '*She **had never seen** snow before that day.*'),
                      Example(
                          icon: Icons.done_all,
                          category: '**Completed Actions (before another):**',
                          sentence:
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      ...
                      '**Past Perfect vs Past Simple:** Past Perfect is for the *earlier* action. Past Simple is for the *later* action in a sequence.',
                      '**Irregular Verbs:** Remember past participles like *gone, seen, eaten, done, been.*',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
