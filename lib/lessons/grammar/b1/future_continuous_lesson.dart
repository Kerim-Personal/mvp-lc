...
class FutureContinuousLessonScreen extends StatefulWidget {
  ...
  @override
  State<FutureContinuousLessonScreen> createState() => _FutureContinuousLessonScreenState();
}

class _FutureContinuousLessonScreenState extends State<FutureContinuousLessonScreen>
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Subject', 'Will Be + Verb-ing', 'Example'],
                    rows: const [
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ['I will not be working.', "I won't be working.", "I won't be working late."],
                      ['You will not be studying.', "You won't be studying.", "You won't be studying now."],
                      ['She will not be coming.', "She won't be coming.", "She won't be coming today."],
                      ['We will not be playing.', "We won't be playing.", "We won't be playing games."],
                      ['They will not be waiting.', "They won't be waiting.", "They won't be waiting long."],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ['Will I be working?', 'Yes, you will.', 'Yes, you will be working.'],
                      ['Will you be studying?', 'No, I won\'t.', 'No, I won\'t be studying.'],
                      ['Will she be coming?', 'Yes, she will.', 'Yes, she will be coming.'],
                      ['Will we be playing?', 'No, we won\'t.', 'No, we won\'t be playing.'],
                      ['Will they be waiting?', 'Yes, they will.', 'Yes, they will be waiting.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      ...
                      '**Polite Questions:** Great for asking about future plans without being too direct.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
...
class _ExampleListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final isDark = Theme.of(context).brightness == Brightness.dark;
    return Material(
      color: isDark ? Colors.cyan.shade900.withOpacity(0.25) : Colors.cyan.shade50,
      borderRadius: BorderRadius.circular(12),
      child: InkWell(
        ...
        child: Container(
          ...
          child: Row(
            ...
            children: [
              Icon(example.icon, size: 22, color: Colors.cyan.shade600),
              const SizedBox(width: 12),
              Text(
                example.category,
                style: TextStyle(
