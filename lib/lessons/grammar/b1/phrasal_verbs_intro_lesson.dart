// lib/lessons/grammar/b1/phrasal_verbs_intro_lesson.dart
...
class PhrasalVerbsIntroLessonScreen extends StatefulWidget {
  const PhrasalVerbsIntroLessonScreen({super.key});

  @override
  State<PhrasalVerbsIntroLessonScreen> createState() => _PhrasalVerbsIntroLessonScreenState();
}

class _PhrasalVerbsIntroLessonScreenState extends State<PhrasalVerbsIntroLessonScreen>
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              centerTitle: true,
              title: const Text('Phrasal Verbs (Introduction)',
                  style: TextStyle(
              ...
              background: Container(
                ...
                child: Center(
                  child: Column(
                    ...
                    children: [
                      const Icon(Icons.widgets_outlined, size: 70, color: Colors.white24),
                      const SizedBox(height: 8),
                      Text(
                        'Verb + Particle (up, on, out...)',
                        style: TextStyle(
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    content:
                    "Phrasal verbs combine a base verb with one or two particles (prepositions/adverbs), creating a new meaning. E.g., 'turn on', 'look after', 'give up'. They are common in everyday English!",
                    onSpeak: _speak,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(icon: Icons.lightbulb_outline, category: 'turn on', sentence: 'Please turn on the lights.'),
                      Example(icon: Icons.lightbulb, category: 'turn off', sentence: 'Turn off the TV, please.'),
                      Example(icon: Icons.search, category: 'look up', sentence: 'Look up the word in a dictionary.'),
                      Example(icon: Icons.favorite_border, category: 'give up', sentence: 'Don\'t give up!'),
                      Example(icon: Icons.pets, category: 'look after', sentence: 'She looks after her little brother.'),
                      Example(icon: Icons.directions_run, category: 'run into', sentence: 'I ran into an old friend.'),
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Type', 'Rule', 'Example'],
                    rows: const [
                      ['Separable', 'Object can go between verb and particle', 'turn the TV off / turn off the TV'],
                      ['Pronoun Rule', 'Pronouns MUST go in the middle', 'turn it off (NOT: turn off it)'],
                      ['Inseparable', 'Object must follow the whole phrasal verb', 'look after children (NOT: look children after)'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Type', 'Takes an Object?', 'Example'],
                    rows: const [
                      ['Transitive', 'Yes', 'look up a word, turn off the light'],
                      ['Intransitive', 'No', 'grow up, wake up'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**Memorize in Chunks:** Learn phrasal verbs as a unit (verb + particle).',
                      '**Object Placement:** With separable phrasal verbs, put pronouns in the middle (turn it off).',
                      '**Multiple Meanings:** Many have idiomatic meanings (run into = meet by chance).',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
