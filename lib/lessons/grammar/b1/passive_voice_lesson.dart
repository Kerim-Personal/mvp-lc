...
class PassiveVoiceLessonScreen extends StatefulWidget {
  ...
  @override
  State<PassiveVoiceLessonScreen> createState() =>
      _PassiveVoiceLessonScreenState();
}
              ...
              delegate: SliverChildListDelegate([
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    rows: const [
                      ...
                      [
                        ...
                        '*She painted the picture. → The picture **was painted**.*'
                      ],
                      [
                        '*We will finish the project.*',
                        '*The project will be finished.*',
                        '*We will finish... → The project **will be finished**.*'
                      ],
                      [
                        '*I have eaten the cake.*',
                        '*The cake has been eaten.*',
                        '*I have eaten... → The cake **has been eaten**.*'
                      ],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    // Veri Markdown formatına güncellendi
                    tips: const [
                      '**"By" + Agent:** Use **"by"** to mention *who* did the action (the "agent"), but it\'s often omitted if it\'s unknown or unimportant.',
                      '**No Object Verbs:** Only *transitive verbs* (verbs that take an object) can be made passive. You can\'t say "It was arrived" (✗).',
                      '**Formal Writing:** Passive voice is very common in formal, academic, or scientific writing to sound objective.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
