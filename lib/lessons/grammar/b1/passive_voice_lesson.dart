// lib/lessons/grammar/b1/passive_voice_lesson.dart
...
class PassiveVoiceLessonScreen extends StatefulWidget {
  const PassiveVoiceLessonScreen({super.key});

  @override
  State<PassiveVoiceLessonScreen> createState() => _PassiveVoiceLessonScreenState();
}

class _PassiveVoiceLessonScreenState extends State<PassiveVoiceLessonScreen>
              ...
              delegate: SliverChildListDelegate([
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _LessonBlock(
                    ...
                    content:
                    "The Passive Voice is used when we want to focus on the action or the receiver of the action, rather than who or what is performing the action. It's formed with 'be' + past participle of the main verb.",
                    onSpeak: _speak,
                  ...
                  child: _ExampleCard(
                    ...
                    examples: const [
                      Example(
                          ...
                          category: 'News and Reports:',
                          sentence: 'The meeting was cancelled.'),
                      Example(
                          icon: Icons.build,
                          category: 'Processes:',
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Active', 'Passive', 'Example'],
                    rows: const [
                      ['Subject + Verb + Object', 'Object + Be + PP + (by Subject)', 'Active: John writes the letter.\nPassive: The letter is written by John.'],
                      ['They build houses.', 'Houses are built.', 'They build houses. → Houses are built.'],
                      ['She painted the picture.', 'The picture was painted.', 'She painted the picture. → The picture was painted.'],
                      ['We will finish the project.', 'The project will be finished.', 'We will finish the project. → The project will be finished.'],
                      ['I have eaten the cake.', 'The cake has been eaten.', 'I have eaten the cake. → The cake has been eaten.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    ...
                    headers: const ['Tense', 'Structure', 'Example'],
                    rows: const [
                      ['Present Simple', 'am/is/are + PP', 'The book is read.'],
                      ['Past Simple', 'was/were + PP', 'The book was read.'],
                      ['Present Continuous', 'am/is/are being + PP', 'The book is being read.'],
                      ['Past Continuous', 'was/were being + PP', 'The book was being read.'],
                      ['Present Perfect', 'has/have been + PP', 'The book has been read.'],
                      ['Past Perfect', 'had been + PP', 'The book had been read.'],
                      ['Future Simple', 'will be + PP', 'The book will be read.'],
                      ['Going to', 'am/is/are going to be + PP', 'The book is going to be read.'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _SimplifiedClickableCard(
                    title: 'Questions in Passive',
                    headers: const ['Question Type', 'Structure', 'Example'],
                    rows: const [
                      ['Yes/No', 'Is/Are/Was/Were + Object + PP?', 'Is the book read?'],
                      ['Wh-', 'Wh- + Be + Object + PP?', 'What is eaten?'],
                      ['How', 'How + Be + Object + PP?', 'How is it done?'],
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
                ...
                _AnimatedLessonBlock(
                  ...
                  child: _TipCard(
                    ...
                    tips: const [
                      '**By + Agent:** Use \'by\' to mention who did the action, but it\'s optional.',
                      '**No Object Verbs:** Only transitive verbs (with objects) can be passive.',
                      '**Formal Writing:** Passive is common in formal, academic, or scientific writing.',
                    ],
                    onSpeak: _speak,
                    onTranslate: _showTranslateSheet,
                  ),
